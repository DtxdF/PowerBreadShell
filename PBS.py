...
print "\nNote: to get user privileges: nt authority\system, it is necessary to move the php document generated by PowerBreadShell to a server that can read it as apache, and run the php document from a browser through the server url to the php\n"
